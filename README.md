...
This repository is for implementing module 2 for character pose estimation
...
```
# Next, you need to install some post processing libraries.
...
```
# download cmu model's graph
$ cd models/graph/cmu
$ bash download.sh
# test it on the root of repo
$ python run.py --model=mobilenet_thin --resize=432x368 --image=./images/p1.jpg
```

![inferent_result](./etcs/inference_result2.png)

##### mask.py err= No module named 'pycocotools._mask' error가 나는 경우에만

```
# If you want to train model with coco style dataset, use cocoapi for convenience.
# First, clone cocoapi on somewhere

$ git clone https://github.com/cocodataset/cocoapi
$ pip install cython
$ cd cocoapi/PythonAPI
$ make
# you get pycocotools build.
